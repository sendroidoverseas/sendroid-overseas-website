...
import { Award, BadgeCheck, Building2, FileCheck, Globe2, Handshake, ShieldCheck, Ship } from "lucide-react";
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { icon: BadgeCheck, title: "ISO 9001:2015 Certified", copy: "Quality management system certified to the international ISO 9001:2015 standard." },
